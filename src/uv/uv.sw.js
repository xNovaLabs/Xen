importScripts("/uv/uv.bundle.js"), importScripts("/uv/uv.config.js");
class UVServiceWorker extends EventEmitter {
    constructor(e = __uv$config) {
        super(), e.bare || (e.bare = "/y/"), this.addresses = "string" == typeof e.bare ? [new URL(e.bare, location)] : e.bare.map((e => new URL(e, location))), this.headers = {
            ...
            empty: [204, 304]
        }, this.config = e, this.browser = Ultraviolet.Bowser.getParser(self.navigator.userAgent).getBrowserName(), "Firefox" === this.browser && (this.headers.forward.push("user-agent"), this.headers.forward.push("content-type"))
    }
    async fetch({
        request: e
    }) {
        if (!e.url.startsWith(location.origin + (this.config.prefix || "/x/"))) return fetch(e);
        try {
            const t = new Ultraviolet(this.config);
            "function" == typeof this.config.construct && this.config.construct(t, "service");
            const r = await t.cookie.db();
            t.meta.origin = location.origin, t.meta.base = t.meta.url = new URL(t.sourceUrl(e.url));
            const n = new RequestContext(e, this, t, this.method.empty.includes(e.method.toUpperCase()) ? null : await e.blob());
            if ("blob:" === t.meta.url.protocol && (n.blob = !0, n.base = n.url = new URL(n.url.pathname)), e.referrer && e.referrer.startsWith(location.origin)) {
                const r = new URL(t.sourceUrl(e.referrer));
                (n.headers.origin || t.meta.url.origin !== r.origin && "cors" === e.mode) && (n.headers.origin = r.origin), n.headers.referer = r.href
            }
            const s = await t.cookie.getCookies(r) || [],
                i = t.cookie.serialize(s, t.meta, !1);
            "Firefox" === this.browser && "iframe" !== e.destination && "document" !== e.destination && n.forward.shift(), i && (n.headers.cookie = i), n.headers.Host = n.url.host;
            ...
            if (c.headers.location && (c.headers.location = t.rewriteUrl(c.headers.location)), c.headers["set-cookie"] && (Promise.resolve(t.cookie.setCookies(c.headers["set-cookie"], r, t.meta)).then((() => {
                ...
                })), delete c.headers["set-cookie"]), c.body) switch (e.destination) {
                case "script":
                case "worker":
                ...
                case "iframe":
                case "document":
                    isHtml(t.meta.url, c.headers["content-type"] || "") && (c.body = t.rewriteHtml(await a.text(), {
                        document: !0,
                        injectHead: t.createHtmlInject(this.config.handler, this.config.bundle, this.config.config, t.cookie.serialize(s, t.meta, !0), e.referrer)
                    }))
            }
            return "text/event-stream" === n.headers.accept && (c.headers["content-type"] = "text/event-stream"), this.emit("response", u), u.intercepted ? u.returnValue : new Response(c.body, {
                headers: c.headers,
                status: c.status,
    ...
    getBarerResponse(e) {
        ...
        return {
            ...
            body: this.statusCode.empty.includes(+e.headers.get("x-bare-status")) ? null : e.body
        }
    }
    get address() {
...
class ResponseContext {
    constructor(e, t, r) {
        ...
        this.request = e, this.raw = t, this.ultraviolet = e.ultraviolet, this.headers = n, this.status = s, this.statusText = i, this.body = o
    }
    get url() {
...
class RequestContext {
    constructor(e, t, r, n = null) {
        this.ultraviolet = r, this.request = e, this.headers = Object.fromEntries([...e.headers.entries()]), this.method = e.method, this.forward = [...t.headers.forward], this.address = t.address, this.body = n || null, this.redirect = e.redirect, this.credentials = "omit", this.mode = "cors" === e.mode ? e.mode : "same-origin", this.blob = !1
    }
    get send() {
        return new Request(this.blob ? "blob:" + location.origin + this.url.pathname : this.address.href + "v1/", {
            method: this.method,
            headers: {
                "x-bare-protocol": this.url.protocol,
                "x-bare-host": this.url.hostname,
                "x-bare-path": this.url.pathname + this.url.search,
                "x-bare-port": this.url.port || ("https:" === this.url.protocol ? "443" : "80"),
...
function isHtml(e, t = "") {
    return "text/html" === (Ultraviolet.mime.contentType(t || e.pathname) || "text/html").split(";")[0]
}
class HookEvent {
    #e;
    #t;
...
var ReflectOwnKeys, R = "object" == typeof Reflect ? Reflect : null,
    ReflectApply = R && "function" == typeof R.apply ? R.apply : function(e, t, r) {
...
ReflectOwnKeys = R && "function" == typeof R.ownKeys ? R.ownKeys : Object.getOwnPropertySymbols ? function(e) {
...
function _addListener(e, t, r, n) {
    ...
    if (checkListener(r), void 0 === (i = e._events) ? (i = e._events = Object.create(null), e._eventsCount = 0) : (void 0 !== i.newListener && (e.emit("newListener", t, r.listener ? r.listener : r), i = e._events), o = i[t]), void 0 === o) o = i[t] = r, ++e._eventsCount;
    else if ("function" == typeof o ? o = i[t] = n ? [r, o] : [o, r] : n ? o.unshift(r) : o.push(r), (s = _getMaxListeners(e)) > 0 && o.length > s && !o.warned) {
        o.warned = !0;
        ...
        a.name = "MaxListenersExceededWarning", a.emitter = e, a.type = t, a.count = o.length, ProcessEmitWarning(a)
    }
    return e
}
...
function _listeners(e, t, r) {
    ...
    if (void 0 === n) return [];
    var s = n[t];
    return void 0 === s ? [] : "function" == typeof s ? r ? [s.listener || s] : [s] : r ? unwrapListeners(s) : arrayClone(s, s.length)
}
...
function once(e, t) {
    return new Promise((function(r, n) {
        ...
        eventTargetAgnosticAddListener(e, t, i, {
            once: !0
        }), "error" !== t && addErrorHandlerIfEventEmitter(e, s, {
            once: !0
        })
    }))
}
...
Object.defineProperty(EventEmitter, "defaultMaxListeners", {
    ...
    if (r === t || r.listener === t) 0 == --this._eventsCount ? this._events = Object.create(null) : (delete n[e], n.removeListener && this.emit("removeListener", e, r.listener || t));
        ...
        0 === s ? r.shift() : spliceOne(r, s), 1 === r.length && (n[e] = r[0]), void 0 !== n.removeListener && this.emit("removeListener", e, o || t)
    }
    return this
